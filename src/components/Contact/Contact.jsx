...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      // No more vantaRef needed here
      className="relative flex flex-col items-center justify-center py-24 px-[12vw] md:px-[7vw] lg:px-[20vw] min-h-screen bg-[#131022]" // Add the background color here
    >
      ...
      <div className="relative z-10 w-full">
        ...
        <div className="mt-8 w-full max-w-md bg-[#0d081f]/90 p-6 rounded-lg shadow-lg border border-gray-700">
          ...
          <form ref={form} onSubmit={sendEmail} className="mt-4 flex flex-col space-y-4">
            ...
            <textarea name="message" placeholder="Message" rows="4" required className="w-full p-3 rounded-md bg-[#131025] text-white border border-gray-600 focus:outline-none focus:border-purple-500"/>
